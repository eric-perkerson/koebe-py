...
def abs_flux_on_contributing_edges(edges):
    """Uses absolute value assuming all fluxes are non-negative (use for singular level curves)"""
    flux = 0.0
    for edge in edges:
...
# # file_stem = "non_convex_arm"
# # file_stem = "lowercase_e"
