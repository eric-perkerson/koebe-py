...
def boundary_example():
    ...
    # kappa.x.array[bottom_cells] = np.full_like(bottom_cells, 1, 
    # dtype=ScalarType)
    # top_cells = ct.find(0)
    ...
    #print(print(left_dofs_1, left_dofs_2, left_dofs_3))

    bcs = [bcs_1,bcs_2, bcs_3]
    #print(left_facets_1,left_facets_2,left_facets_3)
    #print(left_dofs_1,left_dofs_2,left_dofs_3)
